...
if (EI03 == null) {
	EI03 = new Weapon("Torture Key", TORTURE_KEY_MIN, TORTURE_KEY_MAX, 1, false, true, true, false);
}
return EI03;
}
...
if (EI04 == null) {
	EI04 = new Weapon("Water Bucket", WATER_BUCKET_MIN, WATER_BUCKET_MAX, 1, false, true, true, false);
}
return EI04;
} 
...
if (FI01 == null) {
	FI01 = new Weapon("Molten Lava Sword", MOLTEN_LAVA_SWORD_MIN, MOLTEN_LAVA_SWORD_MAX, 1, true, true, false, true);
}
return FI01;
}
...
>>>>>>> 44b6eaa14f653588143df03152f04673d1f71b44
}
