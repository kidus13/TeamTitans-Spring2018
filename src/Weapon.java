...
// constructor
public Weapon(String _name, int _addDefense, int _addHealth, int _minDamage, int _maxDamage, int _tradeValue, boolean _equipable, boolean _droppable,
...
return "Weapon [Type = " + getName() + ", Add Defense = " + getAddDefense() + ", Add Health = " + getAddHealth() + ", Trade Value = " 
+ getTradeValue() + ", Equipable = " + isEquipable() + ", Droppable =" + isDroppable() + ", Useable = " + isUseable() + ", Tradable =" 
+ isTradable() + ", Damage = " + getDamage() + "]";
}
