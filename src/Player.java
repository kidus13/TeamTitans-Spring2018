...
System.out.println("Guard's Armor and Sword are availble to pick up! ");
System.out.println("Would you like to pick up items: YES or NO");
...
System.out.println("something available! ");
System.out.println("Would you like to pick up items: YES or NO");
String choice = inputItem.nextLine();
